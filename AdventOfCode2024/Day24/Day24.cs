...
namespace AdventOfCode2024
{
	class Day24
	{
		...
		{
			(Dictionary<string, int> values, List<List<string>> connections, Dictionary<string, int?> zValues) = ProcessInput();
		...
		public static (Dictionary<string, int> values, List<List<string>> connections, Dictionary<string, int?> zValues) ProcessInput()
		{
